...
def main():
	...
	for tweet in testingTweets:
		print simple_c.classify_tweet(tweet["text"])
	svm_c.classify(testingTweets, "data/output/SVM_TEST.csv")
	# print "Getting stats..."

	# print "\n"
	# print "------------- Naive Bayes Stats -------------"
	# reader.getStats(NB_output_file)
	# print "\n"

	# print "----------------- SVM Stats -----------------"
	# reader.getStats(SVM_output_file)
	# print "\n"

	# print "---------- Simple Classifier Stats ----------"
	# reader.getStats(Smpl_output_file)
	# print "\n"

	# print "------------ Random Forest Stats ------------"
	# reader.getStats("data/output/RFResult.csv")
	# print "\n"
